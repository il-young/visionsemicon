...
void __fastcall TForm1::Carrier_GridGetCellColor(TObject *Sender, int ARow, int ACol,
...
void __fastcall TForm1::AutoManual1Click(TObject *Sender)
{
	Change_AutoManual_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::LinkStatusChange1Click(TObject *Sender)
{
	Link_Status_Change_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::oAGVPort1Click(TObject *Sender)
{
	Carrier_ToAGVPort_Popup_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::oPGVPort1Click(TObject *Sender)
{
	Carrier_ToPGVPort_Popup_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::FormTo1Click(TObject *Sender)
{
	Carrier_FormTo_popup_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::Lock1Click(TObject *Sender)
{
	Carrier_Lock_Comment_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::Event1Click(TObject *Sender) //설정된 파일 열기
{
	ShellExecute(Handle, L"open", L"notepad", L"D:\\test.txt", 0, SW_SHOW);
}
//---------------------------------------------------------------------------

void __fastcall TForm1::Operation2Click(TObject *Sender) //설정된 파일 열기
{
	ShellExecute(Handle, L"open", L"notepad", L"D:\\test.txt", 0, SW_SHOW);
}
//---------------------------------------------------------------------------

void __fastcall TForm1::HostCommunication1Click(TObject *Sender) //설정된 파일 열기
{
	ShellExecute(Handle, L"open", L"notepad", L"D:\\test.txt", 0, SW_SHOW);
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::LogFolder1Click(TObject *Sender)//설정된 폴더 Open
{
	ShellExecute(NULL, L"runas", L"explorer", L"D:\\Exercise", 0, SW_SHOWDEFAULT);
}
//---------------------------------------------------------------------------

void __fastcall TForm1::Alarm1Click(TObject *Sender)
{
	History_Alarm_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::Event2Click(TObject *Sender)
{
	History_Event_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::ransferCommand1Click(TObject *Sender)
{
	History_TransferCommand_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::Operation3Click(TObject *Sender)
{
	History_Operation_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::CarrierHistory1Click(TObject *Sender)
{
...
void __fastcall TForm1::UserManagement1Click(TObject *Sender)
{
	System_UserManagement_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::UserGrouping1Click(TObject *Sender)
{
	System_UserGrouping_frm->Show();
}
//---------------------------------------------------------------------------

void __fastcall TForm1::MaxPoolLevel1Click(TObject *Sender)
{
